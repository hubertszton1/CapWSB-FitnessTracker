 ...
 * Contains training details with user information.
 */
public class TrainingDto {

    private Long id;
    private UserDto user;
    @JsonFormat(shape = com.fasterxml.jackson.annotation.JsonFormat.Shape.STRING, pattern = "yyyy-MM-dd'T'HH:mm:ss.SSS+00:00")
